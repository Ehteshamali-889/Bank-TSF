...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="col s12 m6">
          <div class="card medium">
            <div class="card-image">
              <img class="cust" src="./images/transfer.png" >
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card medium">
            <div class="card-image">
              <img class="cust" src="./images/Timeline.png"> 
            </div>
  ...
  <footer class="footer">
      <div class="container">
        <span class="text-muted">Made By Ehtesham Ali With Love - The Sparks Foundation</span>
      </div>
    </footer>
